    ...
    <tr>
      <td align="left" style="padding:40px 24px;">
        <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width:700px; margin:0 auto;">
          ...
          <!-- Footer -->
          <tr>
            <td class="border-subtle" style="border-top:1px solid #f1f5f9; padding-top:28px; padding-bottom:20px;">
              <table border="0" cellpadding="0" cellspacing="0" width="100%">
                <tr>
                  <td style="padding-bottom:12px;">
                    <div class="text-primary" style="font-family:${fontFamily}; font-size:14px; font-weight:700; color:#1b1b1d; margin-bottom:4px;">
                      Trung tâm Đổi mới Sáng tạo Gia Lai
                    </div>
                    <div class="text-secondary" style="font-family:${fontFamily}; font-size:13px; color:#505f76; margin-bottom:8px;">
                      Kiến tạo tương lai số bền vững cho doanh nghiệp và cộng đồng.
                    </div>
                    <div class="text-secondary" style="font-family:${fontFamily}; font-size:12px; color:#505f76; margin-bottom:4px; line-height:1.5;">
                      📍 Số 226 Đống Đa, Phường Quy Nhơn, Tỉnh Gia Lai
                    </div>
                    <div class="text-secondary" style="font-family:${fontFamily}; font-size:12px; color:#505f76; line-height:1.5;">
                      ✉️ <a href="mailto:dmstgialai@vdcd.vn" style="color:inherit; text-decoration:none;">dmstgialai@vdcd.vn</a> &nbsp;|&nbsp; 📞 <a href="tel:0373600099" style="color:inherit; text-decoration:none;">0373600099</a> &nbsp;|&nbsp; 🌐 <a href="https://doimoisangtaogialai.vn" style="color:#e80002; text-decoration:none;" target="_blank">doimoisangtaogialai.vn</a>
                    </div>
                  </td>
                </tr>
                <tr>
                  <td class="border-subtle" style="border-top:1px solid #f8fafc; padding-top:12px;">
                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                      <tr>
